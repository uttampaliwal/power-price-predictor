...
MODELS_DIR = os.path.join(os.path.dirname(__file__), "..", "..", "models_no_weather", "xgboost")
PREDS_DIR  = os.path.join(os.path.dirname(__file__), "..", "..", "predictions", "xgboost_no_weather")
...
def run():
    ...
    print_metrics_table("XGBoost No Weather (Val)", compute_all_metrics(y_val, y_val_pred))
